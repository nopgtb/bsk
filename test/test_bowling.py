...
class TestBowlingGame(unittest.TestCase):
    ...
    def test_strike_followed_by_spare(self):
        ...
        game.add_frame(Frame(8, 1))
        game.add_frame(Frame(2, 6))
        self.assertEquals(103, game.calculate_score())
    ...
    def test_strike_followed_by_strike(self):
        ...
        game.add_frame(Frame(8, 1))
        game.add_frame(Frame(2, 6))
        self.assertEquals(112, game.calculate_score())

    def test_spare_followed_by_spare(self):
        game = BowlingGame()
        ...
        game.add_frame(Frame(8, 1))
        game.add_frame(Frame(2, 6))
        self.assertEquals(98, game.calculate_score())
    ...
    def test_spare_as_last_frame(self):
        ...
        self.assertEquals(90, game.calculate_score())
