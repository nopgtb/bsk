...
class TestBowlingGame(unittest.TestCase):
    ...
    def test_multiple_first_bonus_throws(self):
        game = BowlingGame()
        game.add_frame(Frame(1, 5))
        game.add_frame(Frame(3, 6))
        game.add_frame(Frame(7, 2))
        ...
        game.add_frame(Frame(2, 8))
        game.set_first_bonus_throw(7)
        self.assertRaises(BowlingError, game.set_first_bonus_throw, 5)

    def test_strike_as_last(self):
        game = BowlingGame()
        game.add_frame(Frame(1, 5))
        game.add_frame(Frame(3, 6))
        game.add_frame(Frame(7, 2))
        ...
        self.assertEquals(92, game.calculate_score())

    def test_strike_as_last_no_first_bonus(self):
        game = BowlingGame()
        game.add_frame(Frame(1, 5))
        game.add_frame(Frame(3, 6))
        game.add_frame(Frame(7, 2))
        ...
        game.add_frame(Frame(8, 1))
        game.add_frame(Frame(10, 0))
        self.assertRaises(BowlingError, game.set_second_bonus_throw, 5)

    def test_strike_as_last_multiple_second_throws(self):
        game = BowlingGame()
        game.add_frame(Frame(1, 5))
        game.add_frame(Frame(3, 6))
        game.add_frame(Frame(7, 2))
    ...
    def test_best_possible_game(self):
        game = BowlingGame()
        game.add_frame(Frame(10, 0))
        game.add_frame(Frame(10, 0))
        game.add_frame(Frame(10, 0))
        ...
        self.assertEquals(300, game.calculate_score())
